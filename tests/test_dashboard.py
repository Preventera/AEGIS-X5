"""Tests for aegis.dashboard — dashboard server (legacy compatibility)."""
...
class TestDashboardHTML:
    ...
    def test_has_dashboard_views(self) -> None:
        assert "v-overview" in DASHBOARD_HTML
        assert "v-agents" in DASHBOARD_HTML
        assert "v-guard" in DASHBOARD_HTML
    ...
    def test_legacy_alias(self) -> None:
        assert _DASHBOARD_HTML == DASHBOARD_HTML
